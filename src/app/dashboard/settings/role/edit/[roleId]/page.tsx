...
export default function EditRolePage() {
  ...
  useEffect(() => {
    if (role && roleId) {
      ...
      setSelectedPermissionIds(
        role.permissions?.map((permission) => typeof permission === 'string' ? permission : permission._id) || [],
      );
    }
  }, [role, roleId]);
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    updateRoleMutation.mutate(
      { roleId, payload: { name: editName, description: editDescription, permissions: selectedPermissionIds } },
      {
        onSuccess: () => {
      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <form onSubmit={onSubmit} className="space-y-3">
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            ...
            <Button type="submit" disabled={updateRoleMutation.isPending || permissionsLoading}>
